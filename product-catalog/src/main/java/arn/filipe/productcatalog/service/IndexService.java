...
import arn.filipe.productcatalog.helper.Indexes;
import arn.filipe.productcatalog.helper.Util;
...
public class IndexService {
    private static final List<String> INDICES = List.of(Indexes.PRODUCT_INDEX);
